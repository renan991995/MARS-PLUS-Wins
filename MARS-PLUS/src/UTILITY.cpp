...
unsigned int clearlog() {
	system(("del "+para.logdir+"combination.txt 2> NUL").c_str());
	system(("del "+para.logdir+"crossover.txt 2> NUL").c_str());
	system(("del "+para.logdir+"addition.txt 2> NUL").c_str());
	system(("del "+para.logdir+"subtraction.txt 2> NUL").c_str());
	system(("del "+para.logdir+"insertion.txt 2> NUL").c_str());
	system(("del "+para.logdir+"cyclization.txt 2> NUL").c_str());
	system(("del "+para.logdir+"decyclization.txt 2> NUL").c_str());
	system(("del "+para.logdir+"change_ele.txt 2> NUL").c_str());
	system(("del "+para.logdir+"change_bnd.txt 2> NUL").c_str());
	system(("del "+para.logdir+"change_cistrans.txt 2> NUL").c_str());
	system(("del "+para.logdir+"change_chirality.txt 2> NUL").c_str());

    system(("del "+para.logdir+"combination_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"crossover_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"addition_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"subtraction_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"insertion_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"cyclization_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"decyclization_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"change_ele_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"change_bnd_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"change_cistrans_IL.txt 2> NUL").c_str());
    system(("del "+para.logdir+"change_chirality_IL.txt 2> NUL").c_str());
